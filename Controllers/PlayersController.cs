...
namespace TodoApi.Controllers
{
    ...
    public class PlayersController : ControllerBase
    {
        ...
        [HttpGet("/players/{lastName}")]
        public async Task<ActionResult<IEnumerable<Player>>> GetPlayerByLastName(string lastName)
        {
            return await _context.Players.AsQueryable().Where(x => x.LastName == lastName).ToListAsync();
        }
